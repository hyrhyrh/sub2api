...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	store := service.ProvideKiroRPMStore(redisClient)
	kirofamilyStore := service.ProvideKiroFamilyCooldownStore(redisClient)
	...
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, kiroTokenProvider, kiroCooldownStore, store, kirofamilyStore, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService)
