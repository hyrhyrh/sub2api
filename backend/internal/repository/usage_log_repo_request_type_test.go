...
func TestUsageLogRepositoryCreateSyncRequestTypeAndLegacyFields(t *testing.T) {
	...
	mock.ExpectQuery("INSERT INTO usage_logs").
		WithArgs(
			...
			createdAt,
			sqlmock.AnyArg(), // server_processing_ms
			sqlmock.AnyArg(), // upstream_ttfb_ms
			sqlmock.AnyArg(), // upstream_stream_ms
			sqlmock.AnyArg(), // response_delivery_ms
			sqlmock.AnyArg(), // total_latency_ms
			sqlmock.AnyArg(), // access_type
			sqlmock.AnyArg(), // client_country
			sqlmock.AnyArg(), // client_region
		).
