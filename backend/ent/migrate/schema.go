	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[44], UsageLogsColumns[31]},
			},
			{
				Name:    "usagelog_client_country_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[33], UsageLogsColumns[44]},
			},
			{
				Name:    "usagelog_access_type_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[32], UsageLogsColumns[44]},
			},
		},
	}
