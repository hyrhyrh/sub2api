...
type UsageLog struct {
	...
	// Go 内部处理（鉴权/路由/账号选择）
	ServerProcessingMs *int `json:"server_processing_ms,omitempty"`
	// 发出上游请求 → 收到首字节
	UpstreamTtfbMs *int `json:"upstream_ttfb_ms,omitempty"`
	// 上游流式生成时长
	UpstreamStreamMs *int `json:"upstream_stream_ms,omitempty"`
	// Go → 客户端交付耗时（含 nginx → 客户端）
	ResponseDeliveryMs *int `json:"response_delivery_ms,omitempty"`
	// Go 视角端到端总耗时
	TotalLatencyMs *int `json:"total_latency_ms,omitempty"`
	// 入口类型: domain | direct_ip
	AccessType *string `json:"access_type,omitempty"`
	// ISO 国家代码, 例如 CN/US
	ClientCountry *string `json:"client_country,omitempty"`
	// 省/州, 例如 Guangdong/California
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldServerProcessingMs, usagelog.FieldUpstreamTtfbMs, usagelog.FieldUpstreamStreamMs, usagelog.FieldResponseDeliveryMs, usagelog.FieldTotalLatencyMs, usagelog.FieldImageCount:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldAccessType, usagelog.FieldClientCountry, usagelog.FieldClientRegion, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize, usagelog.FieldImageInputSize, usagelog.FieldImageOutputSize, usagelog.FieldImageSizeSource:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldServerProcessingMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field server_processing_ms", values[i])
			} else if value.Valid {
				_m.ServerProcessingMs = new(int)
				*_m.ServerProcessingMs = int(value.Int64)
			}
		case usagelog.FieldUpstreamTtfbMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field upstream_ttfb_ms", values[i])
			} else if value.Valid {
				_m.UpstreamTtfbMs = new(int)
				*_m.UpstreamTtfbMs = int(value.Int64)
			}
		case usagelog.FieldUpstreamStreamMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field upstream_stream_ms", values[i])
			} else if value.Valid {
				_m.UpstreamStreamMs = new(int)
				*_m.UpstreamStreamMs = int(value.Int64)
			}
		case usagelog.FieldResponseDeliveryMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field response_delivery_ms", values[i])
			} else if value.Valid {
				_m.ResponseDeliveryMs = new(int)
				*_m.ResponseDeliveryMs = int(value.Int64)
			}
		case usagelog.FieldTotalLatencyMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field total_latency_ms", values[i])
			} else if value.Valid {
				_m.TotalLatencyMs = new(int)
		...
		case usagelog.FieldClientCountry:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.ClientCountry = new(string)
				*_m.ClientCountry = value.String
			}
		case usagelog.FieldClientRegion:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field client_region", values[i])
			} else if value.Valid {
				_m.ClientRegion = new(string)
				*_m.ClientRegion = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.ServerProcessingMs; v != nil {
		builder.WriteString("server_processing_ms=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.UpstreamTtfbMs; v != nil {
		builder.WriteString("upstream_ttfb_ms=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.UpstreamStreamMs; v != nil {
		builder.WriteString("upstream_stream_ms=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.ResponseDeliveryMs; v != nil {
		builder.WriteString("response_delivery_ms=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	if v := _m.ClientCountry; v != nil {
		builder.WriteString("client_country=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.ClientRegion; v != nil {
		builder.WriteString("client_region=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
